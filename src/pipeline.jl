...
function integrate_light(
    ...
    default_abs_par = clamp(1.0 - get(cfg.general, "scattering_coeff_par", 0.15), 0.0, 1.0)
    default_abs_nir = clamp(1.0 - get(cfg.general, "scattering_coeff_nir", 0.30), 0.0, 1.0)
    for nid in node_ids
        pa =
