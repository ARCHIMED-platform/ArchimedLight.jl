...
function fixture_runtime_data(fx::JuliaFixture)
    ...
    cfg = ArchimedLight.LightConfig(
        ...
        cfg0.area_ratio,
        scattering,
        cfg0.scattering_max_iter,
        cfg0.scattering_stop_ratio,
        cfg0.scattering_coeff_par,
        cfg0.scattering_coeff_nir,
        cfg0.cache_radiation,
        raw,
    )
