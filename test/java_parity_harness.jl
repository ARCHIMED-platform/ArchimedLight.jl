...
const PARITY_LIMITS = Dict{Tuple{Symbol,String},Float64}(
    ...
    (:irr_component_rel_dense, "*") => 8.2e-3,
    ...
    (:cafeier_total_rel, "test-cafeier") => 1.1e-5,
    (:cafeier_total_rel, "test-cafeier2") => 1e-5,
    (:cafeier_total_rel, "test-cafeier_sensor") => 1.1e-5,
...
function light_parity_fixtures()
    entries = [
        ...
        ("test-scattering-two-simpleplants", "test-scattering-two-simpleplants", "config.yml"),
        ("test-toricity-two-simpleplants-border", "test-toricity-two-simpleplants-border", "config.yml"),
        ...
        ("test-parallel", "test-parallel", "config.yml"),
        ("test-parallel2", "test-parallel2", "config.yml"),
        ("test-compare-cafeier1", "test-compare-cafeier1", "archimed2018/config.yml"),
        ("test-compare-cafeier1-lowsun", "test-compare-cafeier1-lowsun", "archimed2018/config.yml"),
        ("test-compare-cafeier1-lowsun1800", "test-compare-cafeier1-lowsun1800", "archimed2018/config.yml"),
        ("test-compare-cafeier2", "test-compare-cafeier2", "archimed2018/config.yml"),
        ("test-compare-cafeier3", "test-compare-cafeier3", "archimed2018/config.yml"),
        ("test-compare-cafeier4", "test-compare-cafeier4", "archimed2018/config.yml"),
        ("test-compare-cafeier5", "test-compare-cafeier5", "archimed2018/config.yml"),
        ("test-compare-simpleplant", "test-compare-simpleplant", "archimed2018/config.yml"),
        ("test-compare-two_coffee", "test-compare-two_coffee", "archimed2018/config.yml"),
        ("test-compare-timestep", "test-compare-timestep", "archimed2018/config.yml"),
        ("test-compare-sky06", "test-compare-sky06", "archimed2018/config.yml"),
        ("test-compare-sky16", "test-compare-sky16", "archimed2018/config.yml"),
        ("test-compare-sky46", "test-compare-sky46", "archimed2018/config.yml"),
